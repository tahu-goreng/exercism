...
def compare_records(azara_record, rui_record):
    ...
    return azara_coord[0]==rui_record[1][0] and azara_coord[1]==rui_record[1][1] 
...
def clean_up(combined_record_group):
    ...
    for tup in combined_record_group:
        cleaned_tuple = tuple(item for index, item in enumerate(tup) if index != 1)
        cleaned += "{}\n".format(cleaned_tuple)
    return cleaned